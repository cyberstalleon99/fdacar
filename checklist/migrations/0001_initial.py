    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inspection_type', models.CharField(choices=[('PLI', 'Post Licensing Inspection'), ('REN', 'Renewal of LTO'), ('INI', 'Initial Inspection'), ('RTN', 'Routine Inspection')], max_length=20, null=True)),
